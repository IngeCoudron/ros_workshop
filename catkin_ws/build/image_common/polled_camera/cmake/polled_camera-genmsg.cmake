...
get_filename_component(_filename "/tmp/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv" NAME_WE)
add_custom_target(_polled_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "polled_camera" "/tmp/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv" "sensor_msgs/RegionOfInterest"
)
...
_generate_srv_cpp(polled_camera
  "/tmp/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv"
  "${MSG_I_FLAGS}"
